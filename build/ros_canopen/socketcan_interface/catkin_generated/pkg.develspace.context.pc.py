...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/usr/catkin_ws_efop/src/ros_canopen/socketcan_interface/include;/usr/include".split(';') if "/usr/catkin_ws_efop/src/ros_canopen/socketcan_interface/include;/usr/include" != "" else []
